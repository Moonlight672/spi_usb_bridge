...
HD_PWD='E:/Xilinx/spi_usb_bridge/spi_usb_bridge.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_spi_flash_usb_bridge.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_spi_flash_usb_bridge.tcl -notrace
