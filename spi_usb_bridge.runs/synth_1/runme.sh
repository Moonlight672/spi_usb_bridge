...
HD_PWD='E:/Xilinx/spi_usb_bridge/spi_usb_bridge.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_spi_flash_usb_bridge.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_spi_flash_usb_bridge.tcl
